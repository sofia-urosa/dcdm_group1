...
# --- read the CSV file ---
df <- read.csv("~/Desktop/Group1/clean_data.csv", stringsAsFactors = FALSE)
# Columns used for second-level duplicate checking
other_cols <- c("gene_symbol","gene_accession_id","mouse_strain","mouse_life_stage", "parameter_id", "parameter_name","analysis_id")   # <-- modify as needed
# Check columns exist
